...
for (i in 1:5) { #change nums here
  urlTopTracks <- gsub(" ", "", paste("http://ws.audioscrobbler.com/2.0/?method=tag.gettoptracks&tag=russian&api_key=aeeeca3484217e70ed731b0e26290c0c&page=", i, "&format=json"))
  topTracks <- jsonlite::fromJSON(urlTopTracks)
  topTracks <- as.data.frame(topTracks) 
  ...
  tracksRussian <- bind_(tracksRussian, topTracks)
}
